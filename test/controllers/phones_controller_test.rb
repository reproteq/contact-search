...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { contacts_id: @phone.contacts_id, telefono: @phone.telefono } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { contacts_id: @phone.contacts_id, telefono: @phone.telefono } }
